  ...
  return (
    <>
      ...
      <div
        ...
        className="fixed inset-y-0 right-0 w-full sm:w-[480px] md:w-[540px] z-40 bg-stone-950/95 text-stone-100 border-l border-stone-800 backdrop-blur-xl shadow-2xl flex flex-col transition-transform duration-300 animate-in slide-in-from-right"
      >
        {/* Top Action Header */}
        <div className="p-4 sm:p-5 border-b border-stone-800 flex items-center justify-between bg-stone-900/50">
          ...
          <div className="flex items-center gap-1.5">
            <button
              ...
              className="px-2.5 py-1.5 rounded-lg bg-stone-800/80 hover:bg-amber-600/30 text-amber-300 text-xs font-sans flex items-center gap-1.5 border border-stone-700/60 transition-colors"
        ...
        <div className="p-4 border-t border-stone-800 bg-stone-900/80 flex items-center justify-between">
          <button
            ...
            onClick={handlePrev}
            disabled={!hasPrev}
            className={`px-3 py-2 rounded-lg text-xs font-sans flex items-center gap-1 border transition-colors ${
              hasPrev
